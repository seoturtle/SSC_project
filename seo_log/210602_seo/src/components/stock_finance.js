...
function Quarter() {
    ...
    useEffect(() => {
        axios.post("http://15.164.94.207:3002/stock_finance/year20_01", {code: storeCode})
        .then(res=>{
            setYear20_01(res.data.result);
        })
        axios.post("http://15.164.94.207:3002/stock_finance/year20_02", {code: storeCode})
        .then(res=>{
            setYear20_02(res.data.result);
        })
        axios.post("http://15.164.94.207:3002/stock_finance/year20_03", {code: storeCode})
        .then(res=>{
            setYear20_03(res.data.result);
        })
        axios.post("http://15.164.94.207:3002/stock_finance/year20_04", {code: storeCode})
        .then(res=>{
...
function Years() {
    ...
    useEffect(() => {
        axios.post("http://15.164.94.207:3002/stock_finance/year18", {code: storeCode})
        .then(res=>{
            setYear18(res.data.result);
        })
        axios.post("http://15.164.94.207:3002/stock_finance/year19", {code: storeCode})
        .then(res=>{
            setYear19(res.data.result);
        })
        axios.post("http://15.164.94.207:3002/stock_finance/year20", {code: storeCode})
        .then(res=>{
