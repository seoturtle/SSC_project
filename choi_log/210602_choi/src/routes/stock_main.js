...
function Stock_main({location}) {
  ...
  series: [
    {
      ...
      data: (function () {
        var chartdata = [];
        axios.post('http://15.164.94.207:3002/search/test', {code: code})
        .then(res => {
  ...
  useEffect(() => {
    ...
    axios.post("http://15.164.94.207:3002/stock_back/graph_header", {code: code})
    .then(res => {
  ...
  const favorite = () => {
    axios.post("http://15.164.94.207:3002/stock_back/favorite", {code: code, idx: decode.idx})
    setFavCheck(1)
    setStoreFav(1)
  }
  const favorite_delete = () => {
    axios.post("http://15.164.94.207:3002/stock_back/favorite_delete", {code: code, idx: decode.idx})
    setFavCheck(0)
    setStoreFav(0)
  }

  useEffect(() => {
    axios.post("http://15.164.94.207:3002/stock_back/favorite_check", {code: code, idx: decode.idx})
    .then(res => {
